...
pub fn build(b: *std.Build) void {
    ...
    // DWARF runtime reader (compiled as separate object)
    const dwarf_obj = b.addObject(.{
        .name = "dwarf_reader",
        .root_module = b.createModule(.{
            .root_source_file = b.path("libcot/codegen/native/dwarf_reader.zig"),
    ...
    // Compiler executable — rooted at libcot/main.zig
    const exe = b.addExecutable(.{
        .name = "cot",
        .root_module = b.createModule(.{
            .root_source_file = b.path("libcot/main.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
