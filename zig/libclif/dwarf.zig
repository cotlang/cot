...
pub const DwarfBuilder = struct {
    ...
    type_reg: ?*const @import("types.zig").TypeRegistry = null,
    ...
    pub fn setTypeRegistry(self: *DwarfBuilder, reg: *const @import("types.zig").TypeRegistry) void {
        self.type_reg = reg;
    }
...
fn resolveTypeNameForDwarf(reg: *const @import("types.zig").TypeRegistry, type_idx: anytype) []const u8 {
